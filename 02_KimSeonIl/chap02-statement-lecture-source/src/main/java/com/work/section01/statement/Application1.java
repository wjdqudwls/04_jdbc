package com.work.section01.statement;
...
import static com.work.common.JDBCTemplate.*;
...
public class Application1 {
  public static void main(String[] args) {
    ...
    try {
      ...
      String sql = "SELECT * FROM tbl_menu";  //DQL Data Query Language(질의 언어)
...
//        //한행에서 특정 컬럼 값을 자바 자료형에 맞춰 얻어오기
        ...
        System.out.println("menu_name : " + rset.getString("menu_code"));
